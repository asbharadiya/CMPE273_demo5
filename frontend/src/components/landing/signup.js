...
class Signup extends Component {
  ...
  handleSubmit() {
    ...
    if(this.dateOfBirth.value === ''){
      this.setState({dateOfBirthError:"Please enter your date of birth"});
      isFormValid = false;
    }
    if(isFormValid) {
	...
	render() {
  	return (
            ...
            <div className="form-group">
              <span className="error">{this.state.dateOfBirthError}</span>
              <input type="date" className="form-control" placeholder="Date of birth" ref={(dateOfBirth) => this.dateOfBirth = dateOfBirth}/>
            </div>
